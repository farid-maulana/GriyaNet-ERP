...
class SellerPolicy
{
    ...
    {
        return $user->can('delete_any_seller');
    }
    ...
    {
        return $user->can('force_delete_any_seller');
    }
    ...
    {
        return $user->can('restore_any_seller');
    }
    ...
    {
        return $user->can('replicate_seller');
    }
    ...
    {
        return $user->can('reorder_seller');
    }
}
